...
public class Router: NSObject {
    ...
    public func webViewController(routeUrl: String,delegate1:WebViewDelegate) -> UIViewController? {
        return webViewController(routeUrl: routeUrl,delegate1:delegate1,params: [:])
    }
    
    public func webViewController(routeUrl: String, delegate1:WebViewDelegate,params: [String : String]) -> UIViewController? {
        if let delegate = delegate, let vc = delegate.viewController(for: routeUrl, params: params) {
            return vc
        } else if let webView = webView(routeUrl: routeUrl,delegate:delegate1, params: params) {
    ...
    public func webView(in routeUrl: String ,delegate:WebViewDelegate) -> WebView? {
        return webView(routeUrl: routeUrl,delegate:delegate, params: [:])
    }
   
    public func webView(routeUrl: String,delegate:WebViewDelegate, params: [String : Any]) -> WebView? {
