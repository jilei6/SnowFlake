...
- (void)moveToBorder:(BOOL)isLeft
{
    ...
    if (isLeft) {
        destinationX = self.stayEdgeDistance-10;
    }
    else {
        CGFloat stayWidth = frame.size.width;
        destinationX = kScreenWidth - self.stayEdgeDistance - stayWidth+10;
    }
...
//    self.contentMode =  UIViewContentModeScaleAspectFill|UIViewContentModeCenter;
