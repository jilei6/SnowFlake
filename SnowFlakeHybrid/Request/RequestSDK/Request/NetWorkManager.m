        ...
        if (self = [super initWithBaseURL:url]) {
          ...
          //  self.requestSerializer.cachePolicy = NSURLRequestReloadIgnoringLocalCacheData;
           ...
           // [self.requestSerializer setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
            ...
            [self.requestSerializer setValue:[NSObject getUserToken] forHTTPHeaderField:@"accessToken"];
            [self.requestSerializer setValue:[NSObject deviceIPAdress] forHTTPHeaderField:@"ip"];
            NSString *userid = [NSObject getUserID] ;
...
+(void)setHeaders:(NSDictionary*)headers
{
    ...
    NetWorkManager * manager  = [self shareManager] ;
    DRAFHTTPRequestSerializer  * requestSerializer =[manager requestSerializer];
    [requestSerializer setValue:[NSObject getUserToken] forHTTPHeaderField:@"accessToken"];
    [requestSerializer setValue:[NSObject deviceIPAdress] forHTTPHeaderField:@"ip"];
    NSString *userid = [NSObject getUserID] ;
    ...
    if (headers!=nil) {
        for (id key in headers.allKeys) {
            ...
            if ([value isKindOfClass:[NSNumber class]]) {
                  [requestSerializer setValue:[value stringValue] forHTTPHeaderField:key];
