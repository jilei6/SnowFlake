...
- (nullable WHC_HttpOperation *)get:(nonnull NSString *)strUrl
    ...
    return [self get:strUrl headers:headerDic process:nil didFinished:finishedBlock];
}
...
- (nullable WHC_HttpOperation *)get:(nonnull NSString *)strUrl
    ...
    if (strUrl != nil && ![_failedUrls containsObject:strUrl]) {
        ...
        getOperation.Headers=headerDic;
...
- (nullable WHC_HttpOperation *)post:(nonnull NSString *)strUrl
                ...
                didFinished:(nullable WHCDidFinished)finishedBlock {
    return [self post:strUrl headers:headerDic param:param  process:nil didFinished:finishedBlock];
}
...
- (nullable WHC_HttpOperation *)post:(nonnull NSString *)strUrl
    ...
    if (strUrl != nil && ![_failedUrls containsObject:strUrl]) {
        ...
        postOperation.Headers=headerDic;
