...
- (id)init
{
    if (self = [super init])
    {
        toastPosition = DRkToastPositionCenter;
        toastDuration = DRkToastDurationNormal;
    }
    return self;
}
...
{
    DRiToast *toast = [[DRiToast alloc]initWithText:text];
    return toast;
}
...
- (void)show
{
    ...
    CGFloat kToastLabelWidth      = DRDEVICE_WIDTH - 15*2 - 10*2;
